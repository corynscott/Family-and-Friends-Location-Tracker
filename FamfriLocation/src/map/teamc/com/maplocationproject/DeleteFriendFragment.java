...
/**
 * 		Class that contains the fragment to view friends and request deletion
 *
 */
public class DeleteFriendFragment extends Fragment{
    ...
    public void onActivityCreated(Bundle savedInstanceState){
    	Log.d("DeleteFriendFragment", "onActivityCreated: savedInstanceState = " + savedInstanceState);
     ...
     */
    private void getListFriendDelete(){
    	client.getListFriendDelete(this.getActivity(), getUserName(), infl);
    }
